...
- (id)init{
    ...
    defautArray = [[NSArray alloc] initWithObjects:@"Favourites",@"Uncategorized",nil];
    customArray = [[NSArray alloc] initWithObjects:@"NLP",@"TimingMate",@"LeetCode",nil];
    listArray = [[NSMutableArray alloc] initWithObjects:defautArray, customArray,nil];
    if(self){
    }
    return self;
}
